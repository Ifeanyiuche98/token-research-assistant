import type { InterpretedSignal, ResearchResult, RiskAnalysis, SignalInterpretation, SignalTone } from '../types/research';
...
function getSummaryFromTone(tone: SignalTone) {
  switch (tone) {
    case 'positive':
...
function getDominantTone(signals: InterpretedSignal[], risk: RiskAnalysis): SignalTone {
